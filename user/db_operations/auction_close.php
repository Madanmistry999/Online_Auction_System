                ...
                while($row2=mysqli_fetch_assoc($selectBidders)){
                    ...
                    if($update_status){
                        ...
                        foreach($bidderEmail as $bidder){
                            ...
                            if($type == 'winner' ){
                                ...
                                $mail2->Host ="smtp.gmail.com";
                                    $mail2->Username ="mistrymadan699@gmail.com";
                                    $mail2->Password ="qmskesryhgwkihzw";

                                    $mail2->SetFrom('mistrymadan699@gmail.com','Auction System');
                        ...
                        $mail1->Host ="smtp.gmail.com";
                            $mail1->Username ="mistrymadan699@gmail.com";
                            $mail1->Password ="qmskesryhgwkihzw";

                            $mail1->SetFrom('mistrymadan699@gmail.com','Auction System');
