<?php
    ...
    // $product_id=mysqli_query($con,"SELECT p_id from products where owner='$uid'");
    ...
    //             $sql=mysqli_query($con,"SELECT * from bids INNER JOIN users on bids.u_id=users.u_id where bids.p_id='$p' ");
                
               
    //             while($bidders_emails=mysqli_fetch_assoc($sql)){
    ...
    //             $confirm_payment=mysqli_query($con,"SELECT confirm from products where p_id='$p'");

    //             $disp=mysqli_fetch_assoc($confirm_payment);
        
    //             $confirmed=$disp['confirm'];
    //         }
    ...
    //     else{
            ...
            if($delete == true){
                ...
                $mail=new PHPMailer(true);
                    ...
                    $mail->Subject ="Your Account is Removed from System";
                    $mail->Body ="Your Account is Removed from System";
                    $mail->AltBody ="Hello User Your Account is Removed from System Because Your Account is Unverified from Long Days ....";
                    $mail->MsgHTML("<h1>Hello User Your Account is Removed from System Because Your Account is Unverified from Long Days....</h1>");
